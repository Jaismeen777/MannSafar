          ...
          <CardHeader>
            <div className="flex items-start md:items-center space-x-4">
              ...
              <div>
                ...
                <CardDescription>View and manage your client list and appointments.</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <div className="p-8 text-center text-muted-foreground border-2 border-dashed rounded-lg">
              <p>Client list, appointment scheduling, and client details will be displayed here.</p>
            </div>
          </CardContent>
        </Card>
      </div>
